(()=>{
  ...
  function watchDrawingToolbar(){const stage=document.querySelector('.chart-stage');if(!stage||stage.dataset.v5DrawWatch)return;stage.dataset.v5DrawWatch='1';new MutationObserver(()=>{if($('drawingToolbar'))installDrawingIcons()}).observe(stage,{childList:true});document.addEventListener('epinnox:drawing-toolbar',installDrawingIcons)}
